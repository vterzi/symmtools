...
class TestPtGrp(TestCase):
    def test_symmelems(self) -> None:
        ...
        symmelems = tuple(point.symmelems(TOL))
        ...
        symmelems = tuple(segment.symmelems(TOL))
        info = SymmetryElements()
        info.include(symmelems, TOL)
        ...
        symmelems = tuple(collinear.symmelems(TOL))
        info = SymmetryElements()
        info.include(symmelems, TOL)
        ...
        symmelems = tuple(triangle.symmelems(TOL))
        info = SymmetryElements()
        info.include(symmelems, TOL)
        ...
        symmelems = tuple(square.symmelems(TOL))
        info = SymmetryElements()
        info.include(symmelems, TOL)
        ...
        symmelems = tuple(pentagon.symmelems(TOL))
        info = SymmetryElements()
        info.include(symmelems, TOL)
        ...
        symmelems = tuple(hexagon.symmelems(TOL))
        info = SymmetryElements()
        info.include(symmelems, TOL)
        ...
        symmelems = tuple(tetrahedron.symmelems(TOL))
        info = SymmetryElements()
        info.include(symmelems, TOL)
        ...
        symmelems = tuple(cube.symmelems(TOL))
        info = SymmetryElements()
        info.include(symmelems, TOL)
        ...
        symmelems = tuple(octahedron.symmelems(TOL))
        info = SymmetryElements()
        info.include(symmelems, TOL)
        self.assertEqual(",".join(info.symbs), "3C4,4C3,6C2,9s,i,4S6,3S4")
        group = PointGroup.from_all_symmelems(symmelems)
        ...
        symmelems = tuple(icosahedron.symmelems(TOL))
        info = SymmetryElements()
        info.include(symmelems, TOL)
        ...
        symmelems = tuple(dodecahedron.symmelems(TOL))
        info = SymmetryElements()
        info.include(symmelems, TOL)
        self.assertEqual(",".join(info.symbs), "6C5,10C3,15C2,15s,i,6S10,10S6")
        group = PointGroup.from_all_symmelems(symmelems)
